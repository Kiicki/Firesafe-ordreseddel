    ...
    var headerHtml =
        '<div class="ke-header">' +
            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 250 85" class="firesafe-logo firesafe-logo--sm" preserveAspectRatio="xMidYMid meet">' +
                '<text x="0" y="37" textLength="180" lengthAdjust="spacingAndGlyphs" font-family="\'Arial Black\', sans-serif" font-weight="900" font-size="36" fill="currentColor" stroke="currentColor" stroke-width="0.7" letter-spacing="0">FIRESAFE</text>' +
